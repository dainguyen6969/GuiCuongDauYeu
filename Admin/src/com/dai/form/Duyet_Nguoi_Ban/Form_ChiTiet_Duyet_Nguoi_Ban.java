...
public class Form_ChiTiet_Duyet_Nguoi_Ban extends javax.swing.JFrame {
    public Form_ChiTiet_Duyet_Nguoi_Ban(String ma_Khach_Hang) {
        ...
        model_Duyet_Nguoi_Ban khachHang = ChucNang_Panel_Duyet_Nguoi_Ban.getDuyetNguoiBan(ma_Khach_Hang);
        lbl_TenNguoiDung.setText(khachHang.getDia_Chi_Lay_Hang());
        lbl_MaKhachHang.setText(khachHang.getID_Nguoi_Mua());
        lbl_Email.setText(khachHang.getTen_Shop());
        lbl_GioiTinh.setText(khachHang.getSo_Dien_Thoai());
        lbl_NgaySinh.setText(khachHang.getTrang_Thai());
        lbl_SoDienThoai.setText(khachHang.getTrang_Thai());
        lbl_NgayTao.setText(khachHang.getEmail());
