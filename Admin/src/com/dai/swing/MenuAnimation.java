...
//Tạo hiệu ứng cho việc xử lý các sự kiện khi người dùng nhấn vào menu
public class MenuAnimation {
    ...
    public MenuAnimation(MigLayout layout, Component component, int duration) { // duration dịch trên GG dịch là khoảng
        this.layout = layout;
        this.menuItem = (MenuItem) component;
    ...
    private void initAnimator(Component component, int duration){
        ...
        TimingTarget target = new TimingTargetAdapter(){
            @Override
            public void timingEvent(float fraction) { //fraction theo GG dịch là phân số
                float h;
                if (open) {
